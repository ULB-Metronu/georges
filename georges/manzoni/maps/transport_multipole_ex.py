...
def compute_transport_multipole_ex_tensor(element_parameters: nList) -> np.ndarray:
    ...
    if k1 > 0:
        ...
        T[2, 0, 2] = 2*k2*(2*sin(L*sqrt(k1))*sinh(L*sqrt(k1)) - cos(L*sqrt(k1))*cosh(L*sqrt(k1)) + cosh(L*sqrt(k1)))/(5*k1)
        T[2, 0, 3] = -2*k2*(-2*sin(L*sqrt(k1))*cosh(L*sqrt(k1)) + cos(L*sqrt(k1))*sinh(L*sqrt(k1)) + sinh(L*sqrt(k1)))/(5*k1**(3/2))
        T[2, 1, 2] = -2*k2*(sin(L*sqrt(k1))*cosh(L*sqrt(k1)) + 2*cos(L*sqrt(k1))*sinh(L*sqrt(k1)) - 3*sinh(L*sqrt(k1)))/(5*k1**(3/2))
        T[2, 1, 3] = -2*k2*(sin(L*sqrt(k1))*sinh(L*sqrt(k1)) + 2*cos(L*sqrt(k1))*cosh(L*sqrt(k1)) - 2*cosh(L*sqrt(k1)))/(5*k1**2)
        T[2, 2, 5] = -L*sqrt(k1)*sinh(L*sqrt(k1))/2
        T[2, 3, 5] = -L*cosh(L*sqrt(k1))/2 + sinh(L*sqrt(k1))/(2*sqrt(k1))
        T[3, 0, 2] = 2*k2*(3*sin(L*sqrt(k1))*cosh(L*sqrt(k1)) + cos(L*sqrt(k1))*sinh(L*sqrt(k1)) + sinh(L*sqrt(k1)))/(5*sqrt(k1))
        T[3, 0, 3] = 2*k2*(3*sin(L*sqrt(k1))*sinh(L*sqrt(k1)) + cos(L*sqrt(k1))*cosh(L*sqrt(k1)) - cosh(L*sqrt(k1)))/(5*k1)
        T[3, 1, 2] = 2*k2*(sin(L*sqrt(k1))*sinh(L*sqrt(k1)) - 3*cos(L*sqrt(k1))*cosh(L*sqrt(k1)) + 3*cosh(L*sqrt(k1)))/(5*k1)
        T[3, 1, 3] = 2*k2*(sin(L*sqrt(k1))*cosh(L*sqrt(k1)) - 3*cos(L*sqrt(k1))*sinh(L*sqrt(k1)) + 2*sinh(L*sqrt(k1)))/(5*k1**(3/2))
