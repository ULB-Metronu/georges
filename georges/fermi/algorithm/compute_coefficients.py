...
from compute_quantiles import compute_quantile_4dim, compute_quantile_2dim
...
if __name__ == "__main__":
    ...
    fit_transmission = fit_data.fit(data_transmission["Transmission_cut"], params_transmission,
