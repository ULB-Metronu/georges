...
def plot_phase_space(sequence, beam_observer_beam):
    ...
    manzoni_plot.phase_space(
        observer=beam_observer_beam,
        element="Q1",
        dim=["X", "PX"],
        location="OUT",
        nbins=[51, 51],
...
def test_plotting():
    ...
    input_beam = georges.manzoni.beam.MadXBeam(
        kinematics=kin,
        distribution=georges.generate_from_5d_sigma_matrix(
            n=100000,
            s11=0.0001,
            s22=0.0001,
            s33=0.0005,
