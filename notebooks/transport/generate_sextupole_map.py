...
from numba import njit
    \n\n""")
        ...
        if exact_dpp:
            ...
            f.write(f"""def compute_transport_sextupole_matrix(element_parameters: nList) -> np.ndarray:\n""")
        f.write("""
    ...
    R[5, 5] = 1 \n""")
        ...
        if exact_dpp:
            ...
            f.write(f"""def compute_transport_sextupole_tensor(element_parameters: nList) -> np.ndarray:\n""")
        f.write("""
    L: float = element_parameters[0]
